...
# curl --request GET --url https://api.cloudflare.com/client/v4/zones/$ZONEID_JUSI/dns_records --header 'Content-Type: application/json' --header "Authorization: Bearer $CF_AUTH_TOKEN"

ZONEID_JUSI=c31459017fe654392d87c13d9a5d44c9

RID=614693690cd8be5e6585d0a0dd46148a
